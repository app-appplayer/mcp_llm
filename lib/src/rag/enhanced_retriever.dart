...
/// Enhanced retrieval manager with external vector store support
class EnhancedRetrievalManager {
  final LlmInterface llmProvider;
  final Logger _logger = Logger.getLogger('mcp_llm.enhanced_retrieval_manager');
  ...
  EnhancedRetrievalManager.withDocumentStore({
  ...
  EnhancedRetrievalManager.withVectorStore({
    required LlmInterface llmProvider,
